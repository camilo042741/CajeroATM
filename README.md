...
X Media/Deseado	0 Baja/ Opcional
...
3.1.1	Interfaz gráfica amigable (R01)
...
3.1.2	Acceso exclusivo para administrador (R02)
...
3.1.3	Manejo de alertas y notificaciones (R03)
...
3.1.4	Autenticación de usuario (R04)
...
3.1.5	Validación de montos (R05)
...
3.1.6	Conversión de moneda (R06)
...
3.1.9	Generación de comprobantes (R09)
...
3.1.10	Simulación sin dinero real (R10)
...
3.2.1.1	Tiempo de respuesta rápido
...
3.2.1.2	Procesamiento eficiente de conversiones
...
3.2.1.3	Capacidad de múltiples operaciones consecutivas
...
3.2.1.5	Manejo eficiente del historial de transacciones
...
3.2.2	Seguridad
3.2.2.1	Autenticación de usuario
...
3.2.2.2	Seguridad básica en almacenamiento
•	Función: Proteger la información guardada en el sistema, aunque sea en almacenamiento local.
...
3.2.3	Fiabilidad
3.2.3.1	Integridad de los datos
...
3.2.4.2	Comentarios en el código
...
3.2.5	Portabilidad
3.2.5.1	Uso sin conexión a internet
...
3.2.5.2	Uso exclusivo del lenguaje Java
